...
namespace Utilities
{
    ...
    {
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp15_3342_tuc42605;User id=tuc42605;Password=Aem4aqui";
        String SqlConnectString = "server=np-stem.temple.edu;Database=CIS4396F03;User id=usrCIS4396F03;Password=thunderCats82";
        ...
        public string DoUpdate(String SqlManipulate)
        {
            ...
            try
            {
                return objCmd.ExecuteNonQuery().ToString();
            }
            catch (Exception ex)
            {
                return ex.ToString();
